/* ===========================================================================
   ai-helper.js  ·  v2  ·  Client-side AI helper for Humanize
   ---------------------------------------------------------------------------
...
(function () {
  ...
  const styles = `
    .settings-trigger {
      ...
      color: var(--settings-accent, #A3392C);
      background: rgba(255,255,255,0.92); backdrop-filter: blur(6px);
      padding: 0.5rem 1rem; border-radius: 0;
      border: 2px solid var(--settings-border, #C9C7BA);
    ...
    .settings-trigger:hover {
      background: linear-gradient(135deg, #C97A6C, var(--settings-accent, #A3392C));
      color: #fff; border-color: #fff;
      transform: translateY(-2px) scale(1.05);
      box-shadow: 0 7px 20px rgba(242,94,156,0.35);
    }
    .settings-trigger:active { transform: scale(0.97); }
    .settings-trigger:focus-visible { outline: 3px solid var(--settings-accent, #A3392C); outline-offset: 2px; }
    ...
    .settings-content {
      background: var(--settings-bg, #F7F6F1);
      border-radius: 0; width: 100%; max-width: 430px; max-height: 90vh;
    ...
    .settings-header {
      ...
      background: linear-gradient(135deg, #C97A6C 0%, var(--settings-accent, #A3392C) 60%, #5C6B58 100%);
    }
    .settings-header h3 {
    ...
    .settings-body::-webkit-scrollbar-thumb { background: var(--settings-border, #C9C7BA); border-radius: 0; }
    ...
    .settings-field label {
      ...
      color: var(--settings-accent, #A3392C); text-transform: uppercase;
      letter-spacing: 0.06em; margin: 0;
    }
    .settings-field input, .settings-field select {
      font-family: 'IBM Plex Sans', sans-serif; font-weight: 500; font-size: 0.92rem;
      padding: 0.75rem 0.95rem; border-radius: 0;
      border: 2.5px solid var(--settings-border, #C9C7BA);
      background: #fff; color: var(--settings-text, #1D1E1B); outline: none;
    ...
    .settings-field select option:hover {
      background: var(--settings-sec-bg, #EEEDE6);
      color: var(--settings-accent, #A3392C);
    }
    ...
    .mini-btn {
      ...
      border: 2.5px solid var(--settings-border, #C9C7BA);
      background: #fff; color: var(--settings-accent, #A3392C);
    ...
    .mini-btn:hover { background: var(--settings-accent, #A3392C); color: #fff; border-color: var(--settings-accent, #A3392C); transform: translateY(-1px); }
    ...
    .settings-help {
      ...
      color: var(--settings-text, #55564E); line-height: 1.5; margin-top: 0.05rem;
    }
    .settings-help a { color: var(--settings-accent, #A3392C); text-decoration: none; font-weight: 700; }
    ...
    .settings-status.busy { color: var(--settings-text, #55564E); }
    ...
    .settings-checkbox { width: 19px; height: 19px; cursor: pointer; flex-shrink: 0; accent-color: var(--settings-accent, #A3392C); }
    .settings-checkbox-label {
      font-family: 'IBM Plex Sans', sans-serif; font-size: 0.88rem; font-weight: 600;
      color: var(--settings-text, #1D1E1B); cursor: pointer; user-select: none;
    }

    .save-settings-btn {
      background: linear-gradient(135deg, #C97A6C 0%, var(--settings-accent, #A3392C) 60%, #5C6B58 100%);
      color: #fff; border: none; border-radius: 0; padding: 0.95rem;
      font-family: 'IBM Plex Mono', monospace; font-size: 1rem; font-weight: 600; cursor: pointer;
    ...
    .settings-privacy {
      font-family: 'IBM Plex Sans', sans-serif; font-size: 0.76rem; line-height: 1.55;
      font-weight: 500; color: var(--settings-text, #1D1E1B);
      background: var(--settings-sec-bg, #EEEDE6);
      border: 2px solid var(--settings-border, #C9C7BA);
      border-radius: 0; padding: 0.75rem 0.9rem;
    }
    .settings-privacy code {
      font-family: ui-monospace, 'SF Mono', Menlo, Consolas, monospace;
      font-size: 0.72rem; background: rgba(0,0,0,0.05); padding: 0.05em 0.35em; border-radius: 0;
    }

    .ai-toast {
      position: fixed; bottom: 20px; left: 50%; transform: translateX(-50%);
      background: #333; color: #fff; padding: 9px 18px; border-radius: 0;
    ...
    .history-trigger:focus-visible { outline: 3px solid var(--settings-accent, #A3392C); outline-offset: 2px; }
    .history-badge {
      background: var(--settings-accent, #A3392C); color: #fff;
      font-size: 0.68rem; font-weight: 700; border-radius: 0; padding: 0.04rem 0.42rem; line-height: 1.5;
    }

    .hist-filters { display: flex; gap: 0.4rem; flex-wrap: wrap; align-items: center; }
    .hist-chip {
      cursor: pointer; font-family: 'IBM Plex Mono', monospace; font-size: 0.76rem; font-weight: 600;
      padding: 0.34rem 0.8rem; border-radius: 0; border: 2px solid var(--settings-border, #C9C7BA);
      background: #fff; color: var(--settings-accent, #A3392C);
      transition: transform 0.15s cubic-bezier(0.34,1.56,0.64,1), background 0.18s, color 0.18s, border-color 0.18s;
    }
    ...
    .hist-empty {
      text-align: center; color: var(--settings-text, #55564E);
      font-family: 'IBM Plex Sans', sans-serif; font-weight: 600; line-height: 1.6; padding: 1.6rem 0.5rem;
    }
    .hist-item {
      background: var(--settings-bg, #F7F6F1);
      border: 2px solid var(--settings-border, #C9C7BA);
      border-left-width: 6px; border-radius: 0; padding: 0.85rem 0.95rem;
    }
    .hist-item[data-tool="charm"] { border-left-color: #A3392C; }
    .hist-item[data-tool="flirt"] { border-left-color: #5C6B58; }
    .hist-meta {
    ...
    .hist-item[data-tool="charm"] .hist-tool { color: #A3392C; }
    .hist-item[data-tool="flirt"] .hist-tool { color: #5C6B58; }
    .hist-vibe {
      font-size: 0.7rem; text-transform: uppercase; letter-spacing: 0.04em;
      background: var(--settings-sec-bg, #EEEDE6); color: var(--settings-text, #1D1E1B);
      padding: 0.1rem 0.5rem; border-radius: 0;
    }
    .hist-time { margin-left: auto; color: var(--settings-text, #55564E); font-weight: 500; font-size: 0.72rem; }
    .hist-params {
      margin-top: 0.5rem; padding: 0.5rem 0.6rem; border-radius: 0;
      background: var(--settings-sec-bg, #EEEDE6);
      font-family: 'IBM Plex Sans', sans-serif; font-size: 0.76rem; line-height: 1.5; color: var(--settings-text, #1D1E1B);
    }
    .hist-params b { color: var(--settings-accent, #A3392C); font-weight: 700; }
    .hist-text {
      margin-top: 0.55rem; font-family: 'IBM Plex Sans', sans-serif; font-size: 0.9rem;
      font-weight: 500; line-height: 1.6; color: var(--settings-text, #1D1E1B); white-space: pre-wrap;
    }
  ...
  //     browser (localStorage 'ai_history_hz'). Each entry is tagged by tool and
  //     keeps the parameters that produced it.
  // ──────────────────────────────────────────────────────────────────────
  const HISTORY_KEY = 'ai_history_hz';
  ...
  function renderHistory() {
    ...
    const controls =
      `<div class="settings-inline" style="justify-content:space-between;align-items:center;flex-wrap:wrap;gap:0.5rem;">
        <div class="hist-filters">
          ${chip('all', 'All')}${chip('humanize', '✒️ Humanize')}
        </div>
    ...
    if (!items.length) {
      body.innerHTML = controls +
        `<div class="hist-empty">No history yet.<br>Rewrites you generate are saved here — on this device only.</div>`;
      return;
    }

    const list = items.map((it) => {
      const meta = TOOL_META[it.tool] || TOOL_META.humanize;
